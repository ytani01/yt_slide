...
**残っている項目: TODO-106。** これまでに 105 件を決着させた。
新しく足すときは「完了済み」の上に節を作る。**番号は `TODO-107` から。**
...
売りは「JS は要るが、一から書かなくてよい」ほうで、型 19 種と AI 作成という
材料は README の下部に既にある。それを冒頭へ上げる。

「ビルド不要」自体は再生側の事実なので消さない。README の再生・配布の説明に
